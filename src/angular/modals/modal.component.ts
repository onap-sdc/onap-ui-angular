...
export class ModalComponent implements OnInit {
    ...
    private warningSvg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30" viewBox="0 0 24 24"><path fill="#ffb81c" id="alert-a" d="M20.5815,18.7997 C20.3815,
    ...
    15.8 11.9,15.499 11.7,15.3 C11.3,14.9 10.7,14.9 10.3,15.3"/></svg>`;
