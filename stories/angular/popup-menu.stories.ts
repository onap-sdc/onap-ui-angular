...
// import { PopupMenuListComponent, PopupMenuItemComponent } from '../../src/angular/components';
// import { RippleClickAnimationDirective } from '../../src/angular/animations/ripple-click.animation.directive';

// storiesOf('Form elements|PopupMenu', module)
...
//     })
//   )
//   .add('Simple popup menu', () => {
//       const _label = text('label', 'Simple popup menu');
